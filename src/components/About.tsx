...
export default function About() {
  ...
  return (
    <section id="about" className="relative z-20 bg-black text-white py-32 px-6 md:px-24 border-t border-white/5">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          >
            <h2 className="text-sm font-black tracking-[0.3em] uppercase text-white/40 mb-8">// Professional Summary</h2>
            <p className="text-3xl md:text-5xl font-semibold leading-tight tracking-tight mb-8">
              {summary.split("seeking")[0]} <span className="text-white/40">seeking impactful roles</span> in AI-powered product development.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-px bg-white/10 border border-white/10">
            {skills.map((skill, index) => (
              <motion.div 
                ...
                className="p-10 bg-black hover:bg-zinc-950 transition-colors group"
              >
                ...
                <ul className="space-y-3">
                  {skill.items.map((item) => (
                    <li key={item} className="text-sm text-white/60 font-medium">
                      {item}
                    </li>
                  ))}
                </ul>
        ...
        <motion.div 
          ...
          className="mt-24 p-12 border border-white/10 bg-zinc-950/50 backdrop-blur-xl"
        >
             <blockquote className="text-2xl md:text-4xl font-serif italic text-center text-white/80">
